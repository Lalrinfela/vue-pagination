var VueBootstrapPagination$1 = {
  render: function() {
      ...
      }, [_vm._v(_vm._s(_vm.config.previousText))])]) : _vm._e(), (_vm.pagination.current_page > 1) ? _c('a', {
          attrs: {
              "href": "#",
      ...
      }, [_vm._v(_vm._s(_vm.config.previousText))])]) : _vm._e()]) : _vm._e(), _vm._l((_vm.array), function(num) {
          return _c('li', {
              staticClass: "page-item",
              class: {
      ...
      }, [_vm._v(_vm._s(_vm.config.nextText))])]) : _vm._e(), (_vm.pagination.current_page < _vm.pagination.last_page) ? _c('a', {
          attrs: {
              "href": "#",
